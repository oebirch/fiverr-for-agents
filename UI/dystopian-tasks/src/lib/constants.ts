...
export const MOTIVATIONAL_MESSAGES = [
  'ETERNAL EFFORT, ETERNAL REWARD',
  'WORK HARDER, ACHIEVE GREATNESS',
  'SWEAT BUILDS STRENGTH AND UNITY',
  'PRODUCTIVITY FUELS YOUR FUTURE',
  'ENDLESS TOIL, ENDLESS TRIUMPH',
  'LABOR TODAY, GLORY TOMORROW',
  'STRIVE TOGETHER, RISE TOGETHER',
  'CONQUER FATIGUE THROUGH DEDICATION',
  'HAPPINESS IN EVERY HARD-EARNED SHIFT',
  'OBEY THE CALL, EMBRACE THE VICTORY',
  'UNITY IN WORK, POWER IN PERSEVERANCE',
  'PUSH LIMITS, REAP REWARDS',
  'TOIL WITH PRIDE, LIVE WITH HONOR',
  'EFFORT UNITES, SUCCESS IGNITES',
  'FORGE AHEAD, CLAIM YOUR DESTINY'
]
